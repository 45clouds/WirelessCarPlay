...
#if (defined( __GNUC__ ) && !defined( __QNX__ )) && defined( __i386__ ) \
...
#if defined( VIA_ACE_POSSIBLE ) && !defined( USE_VIA_ACE_IF_PRESENT )
#  define USE_VIA_ACE_IF_PRESENT  1
#endif
...
#if (defined( ASM_X86_V2 ) || defined( ASM_X86_V2C ))
...
#    define USE_VIA_ACE_IF_PRESENT  0
#  endif
#endif
...
#if USE_VIA_ACE_IF_PRESENT && !defined ( AES_REV_DKS )
#  define AES_REV_DKS
#endif
...
#if defined( ASM_X86_V1C ) && defined( AES_DECRYPT_NEEDED ) && !defined( ISB_SET )
#  define ISB_SET
#endif
